# LinkCrawler
Simple C# console application that will crawl the given webpage for image-tags and hyperlinks. If some of them is not working (HttpStatusCode not equal to 200), an message will be sent to slack. Also request-information on all urls will be written to console output.
